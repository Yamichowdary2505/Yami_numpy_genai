...
if uploaded_file is not None:
    ...
    if df is None:
        st.error(" Could not read the file. Please make sure it is a valid CSV.")
    else:
        ...
        if len(numeric_cols) == 0:
            st.error(" No numeric columns found in this dataset. Please upload a CSV with numeric data.")
        else:
            ...
            if st.button(" Generate Graph"):
                ...
                try:
                    ...
                    st.error(f" Could not generate graph: {e}. Try selecting different columns.")
